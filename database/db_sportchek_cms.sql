...
--
-- Host: localhost:8889
-- Generation Time: Apr 21, 2019 at 04:52 AM
...
(8, 'admin', 'admin', '123', 'admin@admin.com');
...
--
ALTER TABLE `tbl_movies`
  MODIFY `movies_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `tbl_mov_genre`
  MODIFY `mov_genre_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
